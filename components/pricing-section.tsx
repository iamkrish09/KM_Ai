  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Start tracking expenses today.",
      features: [
    ...
    },
    {
      ...
      monthlyPrice: "$19",
      annualPrice: "$9",
      description: "For budget-conscious individuals.",
      features: [
      ...
      buttonText: "Join now",
      buttonClass:
        "bg-primary text-primary-foreground shadow-lg hover:bg-primary-dark",
      popular: true,
    },
    {
      name: "Business",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose the perfect plan for your financial management needs.<br /> Cancel anytime, no hidden fees.
          </p>
        </div>
        <div className="pt-4">
